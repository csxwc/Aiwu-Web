<template>
    <Layout>
        ...
        <Layout style="height:615px">
            <Sider style="background-color:#2d8cf0" hide-trigger width="240px">
...
export default {
    methods:{
        link(key){
            switch (key) {
                case '1':
                    this.$router.push({path:'/user/my_booked'});
                    break;
                case '2':
                    this.$router.push({path:'/user/my_preference'});
                    break;
                case '3':
                    this.$router.push({path:'/user/my_release'});
                    break; 
                case '4':
                    this.$router.push({path:'/user/my_info'});
                    break;   
                default:
                    break;
            }
