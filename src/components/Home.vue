            ...
            <!--<v-header></v-header>-->
                ...
                <div style="width: 100%;" :style="{backgroundImage:'url('+require('../assets/images/2.jpg')+')'}">
                  <div style="width: 75%; text-align: center;margin:0 auto;">
                    ...
                    <div style="font-size:23px;margin-top:20px;text-align: left">热门推荐</div>
                    ...
                    <div style="font-size:23px;margin-top:20px;text-align: left">个性推荐</div>
    ...
    methods: {
      ...
      sendLocation() {
        if (this.selected === '') {
          ...
          // let routeData = this.$router.resolve({ path: '/map'});
